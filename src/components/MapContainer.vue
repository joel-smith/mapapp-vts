<template>
  <div ref="map-root" style="width: 100vw; height: 100vh; style: center"></div>
</template>
...
export default {
  ...
  methods: {
    setIconStyle(
      iconSrc = "https://openlayers.org/en/v4.6.5/examples/data/icon.png"
    ) {
      return new Style({
        image: new Icon({
          anchor: [0.5, 46],
  ...
  mounted() {
    ...
    this.createCenteredMap(
      vectorSource,
      VEHIKL_COORDINATES[0],
      VEHIKL_COORDINATES[1]
    );
  },
};
</script>
